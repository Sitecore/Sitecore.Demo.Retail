...
namespace Sitecore.Reference.Storefront.Infrastructure
{
    ...
    /// </summary>
    public class DependenciesConfigurator : IServicesConfigurator
    {
        public void Configure(IServiceCollection serviceCollection)
        {
            ...
            container.Register(Classes.FromAssemblyContaining<CartServiceProvider>().Pick().WithService.DefaultInterfaces());
