    ...
    public class InitializeEnvironmentPricingBlock : PipelineBlock<string, string, CommercePipelineExecutionContext>
    {
        ...
        public override async Task<string> Run(string arg, CommercePipelineExecutionContext context)
        {
            ...
            try
            {
                ...
                this.CreateProductsCard(adventureBook, context);

                this.CreateVariantsCard(adventureBook, context);

                this.CreateTagsCard(adventureBook, context);
            }
            catch (Exception ex)
            {
        ...
        private void CreateProductsCard(PriceBook book, CommercePipelineExecutionContext context)
        {
            ...
            // ADVENTURE CARD
            var adventureCard = this._addPriceCardPipeline.Run(new AddPriceCardArgument(book, "AdventureWorksPriceCard"), context).Result;
