// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ProvisionDigitalProductEntitlementsBlock.cs" company="Sitecore Corporation">
...
namespace Plugin.Sample.Habitat
{
    ...
    /// <summary>
    /// Defines the provision digital product entitlements block.
    /// </summary>
    /// <seealso>
    ///     <cref>
    ...
    ///     </cref>
    /// </seealso>
    [PipelineDisplayName(HabitatConstants.Pipelines.Blocks.ProvisionDigitalProductEntitlementsBlock)]
    public class ProvisionDigitalProductEntitlementsBlock : PipelineBlock<IEnumerable<Entitlement>, IEnumerable<Entitlement>, CommercePipelineExecutionContext>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProvisionDigitalProductEntitlementsBlock"/> class.
        /// </summary>
