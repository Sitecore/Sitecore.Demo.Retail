// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GetCustomerInstallationEntitlementDetailsViewBlock.cs" company="Sitecore Corporation">
...
namespace Plugin.Sample.Habitat
{
    ...
    /// <summary>
    /// Defines the get order installation entitlement details view block.
    /// </summary>
    /// <seealso>
    ///     <cref>
    ...
    ///     </cref>
    /// </seealso>
    [PipelineDisplayName(HabitatConstants.Pipelines.Blocks.GetCustomerInstallationEntitlementDetailsViewBlock)]
    public class GetCustomerInstallationEntitlementDetailsViewBlock : PipelineBlock<EntityView, EntityView, CommercePipelineExecutionContext>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCustomerInstallationEntitlementDetailsViewBlock"/> class.
        /// </summary>
