// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GetOrderInstallationEntitlementDetailsViewBlock.cs" company="Sitecore Corporation">
...
namespace Plugin.Sample.Habitat
{
    ...
    ///     </cref>
    /// </seealso>
    [PipelineDisplayName(HabitatConstants.Pipelines.Blocks.GetOrderInstallationEntitlementDetailsViewBlock)]
    public class GetOrderInstallationEntitlementDetailsViewBlock : PipelineBlock<EntityView, EntityView, CommercePipelineExecutionContext>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetOrderInstallationEntitlementDetailsViewBlock"/> class.
        /// </summary>
