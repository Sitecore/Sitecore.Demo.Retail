// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GetCustomerDigitalProductEntitlementDetailsViewBlock.cs" company="Sitecore Corporation">
...
namespace Plugin.Sample.Habitat
{
    ...
    public class GetCustomerDigitalProductEntitlementDetailsViewBlock : PipelineBlock<EntityView, EntityView, CommercePipelineExecutionContext>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCustomerDigitalProductEntitlementDetailsViewBlock"/> class.
        /// </summary>
