// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GetOrderDigitalProductEntitlementDetailsViewBlock.cs" company="Sitecore Corporation">
...
namespace Plugin.Sample.Habitat
{
    ...
    /// <summary>
    /// Defines the get order digital product entitlement details view block.
    /// </summary>
    /// <seealso>
    ///     <cref>
    ...
    ///     </cref>
    /// </seealso>
    [PipelineDisplayName(HabitatConstants.Pipelines.Blocks.GetOrderDigitalProductEntitlementDetailsViewBlock)]
    public class GetOrderDigitalProductEntitlementDetailsViewBlock : PipelineBlock<EntityView, EntityView, CommercePipelineExecutionContext>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetOrderDigitalProductEntitlementDetailsViewBlock"/> class.
        /// </summary>
