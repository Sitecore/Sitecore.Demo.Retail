// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ProvisionWarrantyEntitlementsBlock.cs" company="Sitecore Corporation">
...
namespace Plugin.Sample.Habitat
{
    ...
    /// <summary>
    /// Defines the provision warranty entitlements block.
    /// </summary>
    /// <seealso>
    ///     <cref>
    ...
    ///     </cref>
    /// </seealso>
    [PipelineDisplayName(HabitatConstants.Pipelines.Blocks.ProvisionWarrantyEntitlementsBlock)]
    public class ProvisionWarrantyEntitlementsBlock : PipelineBlock<IEnumerable<Entitlement>, IEnumerable<Entitlement>, CommercePipelineExecutionContext>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Plugin.Sample.Habitat.ProvisionWarrantyEntitlementsBlock"/> class.
        /// </summary>
