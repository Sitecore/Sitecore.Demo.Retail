    ...
    public class UpdateParties : CustomerPipelineProcessor
    {
        public override void Process(ServicePipelineArgs args)
        {
            ...
            foreach (var partyToUpdate in request.Parties)
            {
                ...
                {
                    customerProfile[global::Sitecore.Foundation.Commerce.Website.Constants.Profile.GeneralInfo.PreferredAddress].Value = partyToUpdate.ExternalId;
                ...
                PipelineUtility.RunCommerceConnectPipeline<TranslateEntityToCommerceAddressProfileRequest, CommerceResult>(global::Sitecore.Foundation.Commerce.Website.Infrastructure.Connect.Pipelines.Constants.Pipelines.TranslateEntityToCommerceAddressProfile, translateToEntityRequest);
