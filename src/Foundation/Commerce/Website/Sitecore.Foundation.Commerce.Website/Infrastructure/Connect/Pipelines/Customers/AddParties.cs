...
namespace Sitecore.Foundation.Commerce.Website.Infrastructure.Connect.Pipelines.Customers
{
    public class AddParties : CustomerPipelineProcessor
    {
        ...
        private Party ProcessCommerceParty(AddPartiesResult result, Profile customerProfile, CommerceParty partyToAdd)
        {
            ...
            PipelineUtility.RunCommerceConnectPipeline<TranslateEntityToCommerceAddressProfileRequest, CommerceResult>(global::Sitecore.Foundation.Commerce.Website.Infrastructure.Connect.Pipelines.Constants.Pipelines.TranslateEntityToCommerceAddressProfile, requestToCommerceProfile);
            ...
            if (partyToAdd.IsPrimary)
                customerProfile[global::Sitecore.Foundation.Commerce.Website.Constants.Profile.GeneralInfo.PreferredAddress].Value = partyToAdd.ExternalId;
            ...
            PipelineUtility.RunCommerceConnectPipeline<TranslateCommerceAddressProfileToEntityRequest, CommerceResult>(global::Sitecore.Foundation.Commerce.Website.Infrastructure.Connect.Pipelines.Constants.Pipelines.TranslateCommerceAddressProfileToEntity, requestToEntity);
