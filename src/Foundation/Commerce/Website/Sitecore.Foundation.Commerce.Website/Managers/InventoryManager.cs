...
namespace Sitecore.Foundation.Commerce.Website.Managers
{
    public class InventoryManager : IManager
    {
        ...
        private void GetProductStockStatusFromIndex(IEnumerable<IInventoryProduct> viewModelList)
        {
            ...
            {
                var predicate = PredicateBuilder.Create<InventorySearchResultItem>(item => item[global::Sitecore.Foundation.Commerce.Website.Constants.CommerceIndex.Fields.InStockLocations].Contains("Default"));
                predicate = predicate.Or(item => item[global::Sitecore.Foundation.Commerce.Website.Constants.CommerceIndex.Fields.OutOfStockLocations].Contains("Default"));
                predicate = predicate.Or(item => item[global::Sitecore.Foundation.Commerce.Website.Constants.CommerceIndex.Fields.OrderableLocations].Contains("Default"));
                predicate = predicate.Or(item => item[global::Sitecore.Foundation.Commerce.Website.Constants.CommerceIndex.Fields.PreOrderable].Contains("0"));
                ...
                foreach (var result in results)
                {
                    ...
                    var isInStock = resultDocument.Fields.ContainsKey(global::Sitecore.Foundation.Commerce.Website.Constants.CommerceIndex.Fields.InStockLocations)
                                    && resultDocument.Fields[global::Sitecore.Foundation.Commerce.Website.Constants.CommerceIndex.Fields.InStockLocations] != null;
                    if (isInStock)
                    {
                    ...
                    {
                        var isPreOrderable = resultDocument.Fields.ContainsKey(global::Sitecore.Foundation.Commerce.Website.Constants.CommerceIndex.Fields.PreOrderable)
                        ...
                        {
                            var isOutOfStock = resultDocument.Fields.ContainsKey(global::Sitecore.Foundation.Commerce.Website.Constants.CommerceIndex.Fields.OutOfStockLocations)
                                               && result.Document.OutOfStockLocations != null;
                            var isBackOrderable = resultDocument.Fields.ContainsKey(global::Sitecore.Foundation.Commerce.Website.Constants.CommerceIndex.Fields.OrderableLocations)
