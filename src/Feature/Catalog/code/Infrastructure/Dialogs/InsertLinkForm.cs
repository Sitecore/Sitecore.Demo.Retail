...
namespace Sitecore.Feature.Commerce.Catalog.Infrastructure.Dialogs
{
    /// <summary>
    /// This dialog is overriden to cater for selecting catalog items
    /// </summary>
    public class InsertLinkForm : Shell.Controls.RichTextEditor.InsertLink.InsertLinkForm
    {
        ...
        {
            return selectedItem.Paths.IsContentItem || selectedItem.IsDerived(Foundation.Commerce.Templates.Commerce.CatalogItem.Id);
        }
